""""
 idetect.py - Image detection using supplied frozen inference graph on the
 provided jpeg image

 python idetect.py ./path/to/frozen/inference/graph.pb ./path/to/label/map.pbtxt ./some/path/image.jpg
